...
interface WrittenOralModeProps {
  category: string;
  onComplete: (score: number, total: number) => void;
}

const WrittenOralMode: React.FC<WrittenOralModeProps> = ({ category, onComplete }) => {
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.instructionsContainer}>
          ...
          <Text style={styles.instructionsText}>
            Toca el botón de grabación y responde la pregunta hablando
          </Text>
        </View>
        ...
        {!showResult && (
          <View style={styles.recordingContainer}>
            <Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
              ...
              >
                <LinearGradient
                  colors={isRecording ? ['#F44336', '#D32F2F'] : ['#4CAF50', '#388E3C']}
...
export default WrittenOralMode;
